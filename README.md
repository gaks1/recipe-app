...
**Recipe App** is a web application for users to add foods and recipes. It allows them to manage them and can make them public for others to see. It also allows them to generate a shopping list for any recipes needed.
...
- **Create food**: Users can create new food and manage it.
- **Create recipes**: Users can create new recipes and manage it.
...
```sh
  cd my-folder
  git clone https://github.com/gaks1/recipe-app.git
```
...
Feel free to check the [issues page](https://github.com/gaks1/recipe-app/issues).
